 ...
 * Document author.
 */
define ('PDF_AUTHOR', 'ACEAD');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Academia de música CEAD');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Dirección: Col. San Ignacio, 5ta calle, cotiguo a Gasolinera TEXACO\nTel: 2239-2330\ne-mail: sistemas@acead.org");
